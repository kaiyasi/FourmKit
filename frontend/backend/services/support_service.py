...
from models.support import (
    SupportTicket, SupportMessage, SupportEvent, TicketWatcher, SupportLabel,
    TicketStatus, TicketCategory, TicketPriority, AuthorType, EventType,
    generate_public_id, generate_pseudonym_code
)
...
class SupportService:
    ...
    def change_status(
        ...
        # 狀態轉換驗證
        valid_transitions = {
            TicketStatus.OPEN: [TicketStatus.AWAITING_USER, TicketStatus.AWAITING_ADMIN, TicketStatus.RESOLVED, TicketStatus.CLOSED],
            TicketStatus.AWAITING_USER: [TicketStatus.AWAITING_ADMIN, TicketStatus.RESOLVED, TicketStatus.CLOSED],
            TicketStatus.AWAITING_ADMIN: [TicketStatus.AWAITING_USER, TicketStatus.RESOLVED, TicketStatus.CLOSED],
            TicketStatus.RESOLVED: [TicketStatus.CLOSED, TicketStatus.REOPENED],
            TicketStatus.CLOSED: [TicketStatus.REOPENED],
            TicketStatus.REOPENED: [TicketStatus.AWAITING_ADMIN, TicketStatus.RESOLVED, TicketStatus.CLOSED]
        }
