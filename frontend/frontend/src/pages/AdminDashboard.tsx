...
import { LayoutDashboard, ShieldCheck, MessagesSquare, Users, Building2, Network, Wrench, Instagram, LifeBuoy, MessageSquareDot, Activity, Server, Crown } from 'lucide-react'
    ...
    <div className="min-h-screen">
      ...
      {/* 平台狀態卡片 - 僅 dev_admin 可見 */}
        ...
        {role === 'dev_admin' && (
          ...
          <Card to="/admin/instagram" title="IG 整合管理" desc="Instagram 帳號管理、發布設定、模板編輯與記錄查看" icon={Instagram} />
        </div>
      </main>
    </div>
  )
