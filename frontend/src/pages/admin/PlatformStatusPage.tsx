      ...
      <main className="mx-auto max-w-6xl px-3 sm:px-4 pt-20 sm:pt-24 md:pt-28 pb-8">
        ...
        <div className="bg-surface border border-border rounded-2xl p-4 sm:p-6 shadow-soft mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold dual-text mb-2">平台狀態管理</h1>
              <p className="text-sm text-muted">監控和管理 ForumKit 平台運行狀態</p>
            </div>
        ...
        {status && (
          <div className="bg-surface border border-border rounded-2xl p-4 mb-6 shadow-soft">
            <div className="flex items-center justify-center gap-3">
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-semibold text-green-800">平台運行正常</h2>
        ...
        {loading && !status ? (
          <div className="bg-surface border border-border rounded-2xl p-8 text-center shadow-soft">
            ...
            <p className="text-muted">載入平台狀態中...</p>
          </div>
        ) : status ? (
          <>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-surface-hover rounded-lg p-3 sm:p-4">
                ...
                <div className="text-lg font-bold text-fg">
                  {new Date(status.current_time).toLocaleTimeString()}
                </div>
                <div className="text-xs text-muted">
                  {new Date(status.current_time).toLocaleDateString()}
                </div>
              </div>
            </div>
          </>
